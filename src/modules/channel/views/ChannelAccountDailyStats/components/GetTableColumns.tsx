...
export default function getTableColumns(dialog: UseDialogExpose, formRef: any, t: any): MaProTableColumns[] {
  ...
  return [
    ...
    { label: () => t('ChannelAccountDailyStats.collection_success_count'), prop: 'collection_success_count' },
    { label: () => t('ChannelAccountDailyStats.collection_failure_count'), prop: 'collection_failure_count' },
    { label: () => t('ChannelAccountDailyStats.disbursement_success_count'), prop: 'disbursement_success_count' },
    { label: () => t('ChannelAccountDailyStats.disbursement_failure_count'), prop: 'disbursement_failure_count' },
    ...
    { label: () => `${t('ChannelAccountDailyStats.collection_success_rate')}(%)`, prop: 'collection_success_rate' },
    { label: () => `${t('ChannelAccountDailyStats.disbursement_success_rate')}(%)`, prop: 'disbursement_success_rate' },
