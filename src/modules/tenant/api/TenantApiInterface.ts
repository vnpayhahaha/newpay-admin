...
// openApi查询
export function page(params: TenantApiInterfaceVo): Promise<ResponseStruct<TenantApiInterfaceVo[]>> {
  return useHttp().get('/admin/tenant/tenant_api_interface/list', { params })
}

// openApi新增
export function create(data: TenantApiInterfaceVo): Promise<ResponseStruct<null>> {
  return useHttp().post('/admin/tenant/tenant_api_interface', data)
}

// openApi编辑
export function save(id: number, data: TenantApiInterfaceVo): Promise<ResponseStruct<null>> {
