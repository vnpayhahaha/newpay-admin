...
import { create, save } from '~/transaction/api/BankDisbursementBillAxisNeft.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: BankDisbursementBillAxisNeftVo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<BankDisbursementBillAxisNeftVo>({})
