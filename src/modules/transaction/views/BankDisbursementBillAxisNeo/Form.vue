...
import { create, save } from '~/transaction/api/BankDisbursementBillAxisNeo.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: BankDisbursementBillAxisNeoVo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<BankDisbursementBillAxisNeoVo>({})
