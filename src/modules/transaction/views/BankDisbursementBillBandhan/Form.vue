...
import { create, save } from '~/transaction/api/BankDisbursementBillBandhan.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: BankDisbursementBillBandhanVo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<BankDisbursementBillBandhanVo>({})
