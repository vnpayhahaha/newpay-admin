...
import { deleteByIds, page } from '~/transaction/api/BankDisbursementBillIcici.ts'
...
defineOptions({ name: 'transaction:bank_disbursement_bill_icici' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('bank_disbursement_bill_icici.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['transaction:bank_disbursement_bill_icici:save']"
          type="primary"
          @click="() => {
