...
import { create, save } from '~/transaction/api/BankDisbursementBillIcici2.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: BankDisbursementBillIcici2Vo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<BankDisbursementBillIcici2Vo>({})
