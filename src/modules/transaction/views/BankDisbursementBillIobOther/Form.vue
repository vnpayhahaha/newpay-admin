...
import { create, save } from '~/transaction/api/BankDisbursementBillIobOther.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: BankDisbursementBillIobOtherVo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<BankDisbursementBillIobOtherVo>({})
