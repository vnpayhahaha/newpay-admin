...
import { deleteByIds, page } from '~/transaction/api/BankDisbursementDownload.ts'
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('bank_disbursement_download.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['transaction:bank_disbursement_download:delete']"
          type="danger"
          plain
