...
import { deleteByIds, page } from '~/transaction/api/TransactionRawData.ts'
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('transaction_raw_data.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['transaction:transaction_raw_data:delete']"
          type="danger"
          plain
